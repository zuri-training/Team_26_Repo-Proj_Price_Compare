  ...
  return (
    <div className='text_container'>
      ...
      <ol>
        ...
        <p>PriceBeta uses the information voluntarily submitted by users in order to enhance their experience on its network of sites, to provide interactice or personalised elements or to deliver preference-based content to the users.</p>
